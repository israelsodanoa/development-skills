...
9. Implement: make small changes and update state/history after meaningful steps. Refresh evidence artifacts when commands, runtime checks, reviews, or waivers produce proof.
...
14. Evidence report: map acceptance criteria to evidence before closeout and keep `evidence/manifest.md` linked to the raw command/runtime/review artifacts.
